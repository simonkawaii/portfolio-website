      ...
      <div className="flex flex-col w-full gap-24 max-w-screen-xl h-full">
        ...
        >
          <div className="flex flex-col">
            <label
              className="mb-4 text-neutral-400 border-[1px] border-transparent"
              htmlFor="contact-email"
            >
              Email
            </label>
            <input
              className=" py-4  appearance-none border-b border-neutral-800 rounded w-full  bg-transparent leading-tight focus:outline-none  focus:border-accent-opposite"
              id="contact-email"
              type="text"
            />
          </div>
          ...
          <div className="flex flex-col">
            <label className="mb-4 text-neutral-400 " htmlFor="contact-message">
              Message
            </label>
            <textarea
              className=" py-4  appearance-none border-b border-neutral-800 rounded w-full  bg-transparent leading-tight  
